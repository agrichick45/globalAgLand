...
shapeSF$TotalCount<-exact_extract(scStock, shapeSF, 'count')
shapeSF$totC_Mean<-exact_extract(scStock, shapeSF, 'mean')
shapeSF$cropGains_Mean<-exact_extract(gains, shapeSF, 'mean')
